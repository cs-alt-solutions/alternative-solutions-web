...
export default function HomePage() {
  ...
  return (
    <main className="flex flex-col items-center w-full min-h-screen overflow-x-hidden font-sans bg-bg-app text-white relative pb-24">
      
      {/* VIBRANT CYAN/TEAL GLOW - Moved here from the old storefronts page */}
      <div className="absolute top-[40%] left-1/2 -translate-x-1/2 w-200 h-200 bg-cyan-500/10 rounded-full blur-[150px] pointer-events-none" />

      {/* 1. The Core Vision & Tech Stack Banner */}
      <HomeHero />

      {/* 2. The Direct Pitch: Professional Storefronts & Pricing (Upgraded Layout) */}
      <div className="relative max-w-7xl mx-auto px-6 w-full mt-12">
