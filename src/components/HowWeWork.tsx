        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {steps.map((step) => (
            <div key={step.icon} className="relative group">
              <div className="text-8xl font-black text-white/5 absolute -top-12 -left-4 transition-colors group-hover:text-brand-primary/10">
                {step.icon}
              </div>
              <div className="relative z-10">
                <h4 className="text-xl font-bold text-white mb-4 flex items-center gap-3">
                  {/* FIXED: Using canonical h-px instead of h-[1px] */}
