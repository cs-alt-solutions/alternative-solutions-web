...
import { Flame, Award, Wind, Zap, RotateCcw, ArrowRight } from 'lucide-react';
import { StorefrontCard } from '../StorefrontComponents';

export default function CatalogDealLanes({ recurringDeals, oneShotDeals, newDropsBucket, premiumWarehouseBucket, smokyStealsBucket, returnedBucket, currentDayName, dayTitle, daySub, cart, updateCart, clientConfig }: any) {
    return (
        <>
