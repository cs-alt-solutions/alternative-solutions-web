...
export default function PortalSidebar({ clientId }: { clientId: string }) { 
  ...
  return ( 
    <> 
      <button 
        className="lg:hidden fixed top-3 left-4 z-50 p-2 bg-zinc-900 border border-zinc-800 rounded-lg text-zinc-300 hover:text-white transition-colors cursor-pointer" 
      ...
      `}> 
        ...
        <div className="flex flex-col px-6 py-8 border-b border-white/5 lg:mt-0 mt-14"> 
          <div className="w-12 h-12 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center mb-4 overflow-hidden shadow-inner shrink-0"> 
            {brandData.logo ? ( 
