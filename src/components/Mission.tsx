  ...
  return (
    <section id="origin" className="py-24 lg:py-40 px-6 relative bg-bg-app border-y border-white/5 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        {/* Changed gap from lg:gap-20 to lg:gap-0 to remove the invisible wall */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-0 items-center">

          {/* 1. CHARACTER SIDE */}
          {/* Added lg:-mr-20 to pull her over, and bumped the z-index so she stands in front */}
          <div className="relative flex justify-center lg:justify-end order-2 lg:order-1 lg:-mr-20 z-30">
            {/* Made the container much taller to give her room to grow, using linter-approved spacing */}
            <div className="relative w-full max-w-md lg:max-w-xl h-125 lg:h-187.5">
               ...
               <Image
                 ...
                 // Added origin-bottom and scale-125 to force her to grow larger from the ground up
          ...
          {/* 2. TEXT SIDE */}
          {/* Added lg:pl-16 so the text has room to breathe now that she is standing so close */}
